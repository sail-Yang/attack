...
class TargetAttackGAN(nn.Module):
    ...
    def _build_model(self):
        ...
        self.prototype_net = PrototypeNet(self.bit, self.num_classes).cuda()
        self.hashing_model = HashModel(self.args)
        self.hashing_model.load_model()
        self.hashing_model = self.hashing_model.model.cuda()
